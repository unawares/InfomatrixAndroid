...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOverlayFocusImageView = view.findViewById(R.id.overlay_focus_image_view);
    ...
    private void startCameraSource() throws SecurityException {
        ...
        if (mCameraSource != null) {
            try {
                mPreview.start(mCameraSource, mGraphicOverlay, mOverlayFocusImageView);
            } catch (IOException e) {
    ...
    @Override
    public void onUpdated(final Barcode barcode) {
    ...
    public interface BarcodeReaderListener {
        void onTouchBarcode(Barcode barcode);
